...
public class GDAuto extends LinearOpMode {
    ...
    Pose2d LD_BLUE_STARTPOS = new Pose2d(farX, startingY, Math.toRadians(0));
    Pose2d LD_RED_STARTPOS = new Pose2d(farX, -startingY, Math.toRadians(0));
    Pose2d SD_BLUE_STARTPOS = new Pose2d(shortX, startingY, Math.toRadians(0));
    Pose2d SD_RED_STARTPOS = new Pose2d(shortX, -startingY, Math.toRadians(0));
