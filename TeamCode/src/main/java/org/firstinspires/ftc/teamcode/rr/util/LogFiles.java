...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = MainMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = MainMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = MainMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = MainMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = MainMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = MainMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = MainMecanumDrive.LATERAL_MULTIPLIER;
